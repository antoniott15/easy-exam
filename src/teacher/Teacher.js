...
export default function Checkout() {
  ...
  const handleNext = () => {
    ...
    if (activeStep === 0) {
      if (validateToken()) {
        axios.post("http://18.217.82.179:8080/question/exam/"+count, {tags}, {
          headers: {
    ...
    if(activeStep === steps.length - 1){
      ...
      if(validateToken()) {
        axios.post("http://18.217.82.179:8080/question/rate",{
          listRate
        },{
          headers: {
            "Authorization":"Bearer "+localStorage.getItem("token")
        ...
        axios.post("http://18.217.82.179:8080/download/exam", {
